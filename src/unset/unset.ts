...
interface UnsetFn {
  ...
  <T, K1 extends keyof T>(source: Nullable<T>, path: [K1]): Nullable<
    Unset1<T, K1>
  >
  <T, K1 extends keyof T, K2 extends keyof U<T[K1]>>(
    source: Nullable<T>,
  ...
  <T, K1 extends keyof T>(source: Undefinable<T>, path: [K1]): Undefinable<
    Unset1<T, K1>
  >
  <T, K1 extends keyof T, K2 extends keyof U<T[K1]>>(
  ...
  <T, K1 extends keyof T>(source: Optional<T>, path: [K1]): Optional<
    Unset1<T, K1>
  >
  <T, K1 extends keyof T, K2 extends keyof U<T[K1]>>(
    source: Optional<T>,
...
const unsetImplementation: UnsetFn = (source: any, path: any[]) => {
