...
interface FpUnsetFnReturn<T> {
  ...
  <K1 extends keyof T>(path: [K1]): (
    source: Nullable<T>,
  ) => Nullable<FpUnset1<T, K1>>
...
const fpUnsetImplementation = <T>(): FpUnsetFnReturn<T> => (path: any[]) => (
  source: any,
